            ...
            if (messageTextWithSlash.charAt(0) == '/') {
                ...
                switch (splitMessageText[0]) {
                    case "createEvent":
                        ...
                        break;
                    case "createQueue":
                        resultText += registerQueue(splitMessageText[1], splitMessageText[2], splitMessageText[3]);
                        break;
                    case "enterQueue":
                    ...
                    case "getEventsByLocation":
                        ...
                        break;
                    case "queueInfo":
                        resultText += findQueue(splitMessageText[1], splitMessageText[2]).getParticipatingUsers().size() +
                                " people left";
                        break;
                    ...
                    if (queue != null) {
                        for (int i = 0; i < queue.getParticipatingUsers().size(); i++) {
                            ...
                            if (i == 0) {
                                ...
                                message.setText("Expected waiting time is " + Integer.parseInt(time) * i + " seconds.\n" +
                                        "You are " + i + (i == 1 ? "st" : (i == 2 ? "nd" : (i == 3 ? "rd" : "th"))) + " in the queue\n");
                            }
                            execute(message);
                        }
